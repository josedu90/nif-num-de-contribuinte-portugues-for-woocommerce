	...
	function webdados_invoicexpress_nag() {
		...
		<div id="webdados_invoicexpress_nag" class="notice notice-info is-dismissible">
			<p style="line-height: 1.4em;">
				...
				<strong><?php _e( 'Are you already issuing automatic invoices on your WooCommerce store?', 'nif-num-de-contribuinte-portugues-for-woocommerce'); ?></strong>
				<br/>
				<?php echo sprintf(
					__( 'If not, get to know our new plugin: %1$sInvoicing with InvoiceXpress for WooCommerce%2$s', 'nif-num-de-contribuinte-portugues-for-woocommerce' ),
					sprintf(
						'<a href="%s" target="_blank">',
						esc_url( __( 'https://invoicexpress-woocommerce.com/', 'nif-num-de-contribuinte-portugues-for-woocommerce' ) )
					),
					'</a>'
				); ?>
				<br/>
				<?php _e( 'Use the coupon <strong>webdados</strong> for 10% discount!', 'nif-num-de-contribuinte-portugues-for-woocommerce' ); ?>
			</p>
		</div>
		<?php
	}
